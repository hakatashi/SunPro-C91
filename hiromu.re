...
@<bib>{phillip}では、@<img>{pix2pix}のように、白黒写真のカラー化から、航空写真からの地図の生成、あるいは、
...
もともとは、WaveNetを使ったネタを書きたいと思っていたのですが、学習がかなり重くデータセットを1周するのに40時間以上掛かる始末だったので、
...
また、pix2pixの実装もとても使いやすく作られており、それも大変ありがたかったです。
